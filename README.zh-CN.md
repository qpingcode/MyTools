...
| **完整版** | **Beta** | 0.0.67 | [下载](https://github.com/qpingcode/MyTools/releases/download/v0.0.67/MyTools-0.0.67-windows-x64-full-setup.exe) | [下载](https://github.com/qpingcode/MyTools/releases/download/v0.0.67/MyTools-0.0.67-windows-x64-full-portable.zip) |
| **精简版** | **Beta** | 0.0.67 | [下载](https://github.com/qpingcode/MyTools/releases/download/v0.0.67/MyTools-0.0.67-windows-x64-lite-setup.exe) | [下载](https://github.com/qpingcode/MyTools/releases/download/v0.0.67/MyTools-0.0.67-windows-x64-lite-portable.zip) |
