...
| --- | --- | --- | --- |
| **Stable** | — | 尚未发布 | 尚未发布 |
| **Beta** | 0.0.34 | [下载](https://github.com/qpingcode/MyTools/releases/download/v0.0.34/MyTools-0.0.34-windows-x64-setup.exe) | [下载](https://github.com/qpingcode/MyTools/releases/download/v0.0.34/MyTools-0.0.34-windows-x64-portable.zip) |
