...
| --- | --- | --- | --- |
| **Stable** | — | 尚未发布 | 尚未发布 |
| **Beta** | 0.0.5 | [下载](https://github.com/qpingcode/MyTools/releases/download/v0.0.5/MyTools-0.0.5-windows-x64-setup.exe) | [下载](https://github.com/qpingcode/MyTools/releases/download/v0.0.5/MyTools-0.0.5-windows-x64-portable.zip) |
