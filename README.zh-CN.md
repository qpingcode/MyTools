...
| --- | --- | --- | --- |
| **Stable** | — | 尚未发布 | 尚未发布 |
| **Beta** | 0.0.35 | [下载](https://github.com/qpingcode/MyTools/releases/download/v0.0.35/MyTools-0.0.35-windows-x64-setup.exe) | [下载](https://github.com/qpingcode/MyTools/releases/download/v0.0.35/MyTools-0.0.35-windows-x64-portable.zip) |
