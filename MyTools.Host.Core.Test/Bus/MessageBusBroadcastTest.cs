...
public class MessageBusBroadcastTest
{
    ...
    public void PluginEvent_ShouldBroadcastToAllWebviewsInTheSameSession()
    {
        ...
        var node = new EndpointId("settings", "main", "s1", "node-main", IsNode: true);
        var web1 = new EndpointId("settings", "main", "s1", "web-1", IsNode: false);
        var web2 = new EndpointId("settings", "main", "s1", "web-2", IsNode: false);
    ...
    public void HostEvent_ShouldBroadcastToAllEndpointsInTheTargetSession()
    {
        ...
        var evt = new Envelope
        {
            ...
            PluginId = "settings", EntryId = "main", EndpointId = "host",
