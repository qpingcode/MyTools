...
export const text = {
    ...
    ResponseFormat: () => bus.i18n.t('Plugin.ApiTester.ResponseFormat', {defaultValue: "Response format"}),
    AutoFormat: (values: {format: string}) => bus.i18n.t('Plugin.ApiTester.AutoFormat', {defaultValue: "Auto ({{format}})", ...values}),
